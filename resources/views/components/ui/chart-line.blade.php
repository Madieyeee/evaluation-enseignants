{{-- resources/views/components/ui/chart-line.blade.php --}}
@props([
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const coloredDatasets = datasets.map((dataset, index) => {
            ...
            const softColors = [theme.colors.primarySoft, 'rgba(16, 185, 129, 0.2)', 'rgba(245, 158, 11, 0.2)', 'rgba(239, 68, 68, 0.2)'];
