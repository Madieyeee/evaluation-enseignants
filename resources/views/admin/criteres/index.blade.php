                    ...
                    <tbody>
                        @forelse($criteres as $critere)
                            <tr class="border-t border-borderColor/30 hover:bg-surface-muted/30 transition-colors">
                                ...
                                <td class="px-4 py-3 text-muted">{{ Str::limit($critere->description, 60) }}</td>
                                <td class="px-4 py-3 text-muted">{{ $critere->poids }}</td>
                                <td class="px-4 py-3">
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="px-4 py-8 text-center text-muted text-sm">Aucun critere enregistre.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
